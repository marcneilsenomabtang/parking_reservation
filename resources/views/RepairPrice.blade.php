    ...
    .sidenav .brand-container a:hover {
        ...
        .dropdown-container.brand-container a {
        text-decoration: none;
        font-size: 11px;
        color: #818181;
        display: block;
        ...
        .dropdown-container#Isuzu {
        top: 25px;
        }
        .dropdown-container#Nissan {
        top: 20px;
        }

        .dropdown-container#Mitsubishi {
        top: 30px;
        }

        .dropdown-container#Mazda {
        top: 120px;
        }

        .dropdown-container#Hyundai {
        top: 120px;
        }

        .dropdown-container#Ford {
        top: 110px;
        }

        .dropdown-container#Chevrolet {
        top: 160px;
        }

        .dropdown-container#Kia {
        top: 250px;
        }

        .dropdown-container#Suzuki {
        top: 200px;
        }
        

        /* Show dropdown container on click */
        .dropdown-btn.active + .dropdown-container.brand-container,
        .dropdown-container.brand-container.active {
        display: block;
        ...
        .dropdown-btn.active {
    background-color: green; /* Add your desired styles here */
...
#resultLabel {
    ...
    <div class="sidenav">
    <div class="dropdown-btn" id="Toyota" onclick="toggleDropdown('Toyota')">Toyota</div>
    <div class="dropdown-container brand-container" id="Toyota">
        <a href="#">Vios</a>
        <a href="#">Altis</a>
        <a href="#">Avanza</a>
        <a href="#">Yaris</a>
    ...
    <div class="dropdown-btn" id="Honda" onclick="toggleDropdown('Honda')">Honda</div>
    <div class="dropdown-container brand-container" id="Honda">
        <a href="#">Civic</a>
        <a href="#">City</a>
        <a href="#">Jazz</a>
        <a href="#">Accord</a>
        <a href="#">CRV 1st to 3rd Gen</a>
        <a href="#">Brio</a>
        <a href="#">B-RV</a>
    ...
    <div class="dropdown-container brand-container" id="Isuzu">
    ...
    <div class="dropdown-btn" id="Nissan" onclick="toggleDropdown('Nissan')">Nissan</div>
    <div class="dropdown-container brand-container" id="Nissan">
    ...
    <div class="dropdown-btn" id="Mitsubishi" onclick="toggleDropdown('Mitsubishi')">Mitsubishi</div>
    <div class="dropdown-container brand-container" id="Mitsubishi">
         <a href="#">Mirage</a>
         <a href="#">Lancer</a>
         <a href="#">Xpander</a>
         <a href="#">Adventure</a>
    ...
    <div class="dropdown-container brand-container" id="Mazda">
        <a href="#">2</a>
        <a href="#">3</a>
        <a href="#">6</a>
        <a href="#">CX5</a>
    ...
    <div class="dropdown-btn" id="Ford" onclick="toggleDropdown('Ford')">Ford</div>
    <div class="dropdown-container brand-container" id="Ford">
        <a href="#">Focus</a>
        <a href="#">Fiesta</a>
        <a href="#">Ecosport</a>
        <a href="#">Escape</a>
        <a href="#">Tribute</a>
        <a href="#">Everest 2015 up New Model</a>
        <a href="#">Ranger</a>
        <a href="#">Raptor</a>
        <a href="#">Explorer</a>
        <a href="#">Expedition</a>
    ...
    <div class="dropdown-btn" id="Chevrolet" onclick="toggleDropdown('Chevrolet')">Chevrolet</div>
    <div class="dropdown-container brand-container" id="Chevrolet">
        <a href="#">Sonic</a>
        <a href="#">Cruze</a>
        <a href="#">Sail</a>
        <a href="#">Spark</a>
        <a href="#">Aveo</a>
        <a href="#">Captiva</a>
        <a href="#">Trail Blazer</a>
        <a href="#">Colorado</a>
    </div>

    <div class="dropdown-btn" id="Kia" onclick="toggleDropdown('Kia')">Kia</div>
    <div class="dropdown-container brand-container" id="Kia">
        <a href="#">Rio</a>
        <a href="#">Picanto</a>
        <a href="#">Soluto</a>
        <a href="#">Sorento</a>
    ...
    <div class="dropdown-btn" id="Suzuki" onclick="toggleDropdown('Suzuki')">Suzuki</div>
    <div class="dropdown-container brand-container" id="Suzuki">
        <a href="#">Swift</a>
        <a href="#">Celerio</a>
        <a href="#">Dzire</a>
        <a href="#">Alto</a>
