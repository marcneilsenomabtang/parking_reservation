...
.adjust-button {
    ...
    left: -100px; /* Adjust the left distance */
...
<button class="adjust-button regular-oil-button" onclick="adjustRegularOilAndFullySynthetic('Regular Oil')">Regular Oil 20w-40  (9Liters)</button>
...
<tbody>
    ...
    function updateBottomText() {
        ...
        if (oilFilterButton.classList.contains('active') && regularOilButton.classList.contains('active')) {
            bottomText.textContent = "Oil & Filter Package and Regular Oil 20w-40 (9 Liters) = ";
            oilAmountLabel.textContent = " ₱4,200.00";
        } else if (oilFilterButton.classList.contains('active') && fullySyntheticButton.classList.contains('active')) {
            bottomText.textContent = "Oil & Filter Package and Fully Synthetic 5w-40 (9 Liters)=";
            oilAmountLabel.textContent = "  ₱7,500.00";
        } else if (flushingButton.classList.contains('active') && regularOilButton.classList.contains('active')) {
            bottomText.textContent = "Flushing and Regular Oil 20w-40  (9 Liters)  = ";
            oilAmountLabel.textContent = " ₱5,260.00";
        } else if (flushingButton.classList.contains('active') && fullySyntheticButton.classList.contains('active')) {
            bottomText.textContent = "Flushing and Fully Synthetic 5w-40 (9 Liters) = 0";
            oilAmountLabel.textContent = " ₱8,350.0";
        } else {
